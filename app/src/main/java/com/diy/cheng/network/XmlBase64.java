...
public class XmlBase64 { 
    /**
     * 服务器端说明鉴于base64编码各平台的字符表后两个字符不一致，统一Base64 字符表 为“ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_/”
     */
	...
	public static boolean needBase64(String s) {
		...
		for(int i=0; i<buff.length; i++) {
			if(buff[i]>=0x20 && buff[i]<=0x7f && buff[i]!='<' && buff[i]!='>' 
	...
	public static void main(String args[]) throws Exception{
    	//String s = new String(new String("�ܽ���").getBytes("IS08859-1"),"UTF-8");
    	//String s = new String("�ܽ���".getBytes(),"UTF-8");
    	byte[]a = "�̽���".getBytes();
    	     //new String(b,"utf-8")
...
//		}    	    	
    	...
    	/*String s2 = new String(new String("�ܽ���").getBytes());
    	byte[]a2 = s2.getBytes();
    	String sEncode2 = encode(s2.getBytes());
    	*/
    	
    	byte[] b = sEncode.getBytes();
        System.out.println("b:" + new String(b));
		/*String queryKeyword = new String(b);
		String sName = new String(b,"utf-8");
